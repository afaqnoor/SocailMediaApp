...
class PoliticalPost extends StatefulWidget {
  const PoliticalPost({Key? key}) : super(key: key);

  @override
  State<PoliticalPost> createState() => _PoliticalPostState();
}

class _PoliticalPostState extends State<PoliticalPost> {
  var _image;
  var video;
  String imageUrl = '';
  String videoUrl = '';
                        ...
                        onPressed: () async {
                          if (description.text.isNotEmpty) {
                            ...
                            try {
                              ...
                              await FireStoreServices.postPolitical(
