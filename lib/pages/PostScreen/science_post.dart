...
class SciencePost extends StatefulWidget {
  const SciencePost({Key? key}) : super(key: key);

  @override
  State<SciencePost> createState() => _SciencePostState();
}

class _SciencePostState extends State<SciencePost> {
  var _image;
  var video;
  String imageUrl = '';
  String videoUrl = '';
                        ...
                        onPressed: () async {
                          if (description.text.isNotEmpty) {
                            ...
                            try {
                              ...
                              await FireStoreServices.postScience(
