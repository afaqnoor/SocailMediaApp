...
class TechnologyPost extends StatefulWidget {
  const TechnologyPost({Key? key}) : super(key: key);

  @override
  State<TechnologyPost> createState() => _TechnologyPostState();
}

class _TechnologyPostState extends State<TechnologyPost> {
  var _image;
  var video;
  String imageUrl = '';
  String videoUrl = '';
                        ...
                        onPressed: () async {
                          if (description.text.isNotEmpty) {
                            ...
                            try {
                              ...
                              await FireStoreServices.postTechnology(
